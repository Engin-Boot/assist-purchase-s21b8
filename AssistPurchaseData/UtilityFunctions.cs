...
namespace AssistPurchaseData
{
    ...
    {
        private readonly List<MonitoringDevice> _monitoringDevices = new List<MonitoringDevice>();
        ...
        public void WriteToXml()
        {
            ...
            var serializer = new XmlSerializer(GetList().GetType(), new XmlRootAttribute("DeviceList"));

            var writer = new StreamWriter(_path);
            serializer.Serialize(writer.BaseStream, GetList());
            writer.Close();
